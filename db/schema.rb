...
ActiveRecord::Schema.define(:version => 20120612203856) do
  ...
  create_table "facturas_compras", :force => true do |t|
    t.integer  "folio"
  ...
  create_table "facturas_ventas", :force => true do |t|
    t.integer  "folio"
    t.date     "fecha_emision"
    t.integer  "neto"
    t.integer  "total_venta"
  ...
  create_table "guias_compras", :force => true do |t|
    t.integer  "folio"
    t.date     "fecha_emision"
    t.integer  "total_venta"
    t.integer  "proveedor_id"
  ...
  create_table "guias_ventas", :force => true do |t|
    t.integer  "folio"
    t.date     "fecha_emision"
    t.integer  "total_venta"
    t.integer  "cliente_id"
